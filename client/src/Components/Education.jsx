      ...
      <div className="container grid gap-6 md:gap-8 px-4 md:px-6 max-w-xl mx-auto lg:max-w-none">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
          <div className="grid gap-1">
            <h2 className="text-2xl font-bold tracking-tight">All educations</h2>
            <p className="text-gray-500 dark:text-gray-400">donate our selection of education by category.</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
         {
             ...
             education.current.map((item,index) => (
